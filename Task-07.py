...
def word(number):
    words = {
        ...
        18:'восемнадцатый',
        19:'девятнадцатый',
        20:['двадцатый', 'двадцать '],
        30:['тридцатый', 'тридцать '],
        40:['сороковой', 'сорок '],
        50:['пятидесятый', 'пятьдесят '],
        60:['шестидесятый', 'шестьдесят '],
        70:['семидесятый', 'семьдесят '],
        80:['восьмидесятый', 'восемьдесят '],
        90:['девяностый' ,'девяносто '],
        100:['сотый', 'сто ']
